...
- **Filtrar productos:** búsqueda de productos por nombre, código o categoría.
...
- **ABM de categorías:** alta, baja y modificación de categorías de productos.
...
- **ABM de proveedores:** alta, baja y modificación de proveedores.
